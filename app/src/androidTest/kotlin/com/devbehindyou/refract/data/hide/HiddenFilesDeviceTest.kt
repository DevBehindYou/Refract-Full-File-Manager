...
class HiddenFilesDeviceTest {
    @get:Rule
    val temporary = TemporaryFolder(ApplicationProvider.getApplicationContext<Context>().cacheDir)
    ...
    fun privateMoveRestoresBytesUsingRealFileNodeId() =
        runBlocking {
            val file =
                temporary.newFile("private-${java.util.UUID.randomUUID()}.bin").apply {
