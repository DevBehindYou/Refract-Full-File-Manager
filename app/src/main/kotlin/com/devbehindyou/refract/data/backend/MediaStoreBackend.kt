...
class MediaStoreBackend
    ...
    constructor(
        ...
        override suspend fun createDirectory(
            parent: FileNodeId,
            name: String,
        ): FileResult<FileNode> = FileResult.Failure(FileError.InvalidDestination(name))
        ...
        ): FileResult<FileNode> = FileResult.Failure(FileError.InvalidDestination(null))
        ...
        companion object {
            ...
            fun rootId(
                volume: String,
                collection: String,
            ): FileNodeId = FileNodeId.media(volume, collection, -1L)
        }
    }
...
private fun MediaRef.toRootFileNode(id: FileNodeId): FileNode =
    FileNode(
        id = id,
        name = collection,
...
private class MediaStoreOutputTarget(
    ...
    override fun stream() =
        resolver.openOutputStream(itemUri, "wt")
