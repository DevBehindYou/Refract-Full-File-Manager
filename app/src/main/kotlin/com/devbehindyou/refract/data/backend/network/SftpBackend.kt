...
/**
 * SFTP (SSH File Transfer Protocol) storage backend conforming to [StorageBackend].
 * Validates connection endpoints, credentials, and provides safe remote I/O.
 */
class SftpBackend(
    ...
    private data class ParsedSftpId(val serverId: String, val path: String)

    private fun parseId(id: FileNodeId): ParsedSftpId {
