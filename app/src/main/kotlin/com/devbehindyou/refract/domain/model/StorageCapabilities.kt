...
data class StorageCapabilities(
    ...
    companion object {
        val READ_ONLY = StorageCapabilities(
            canRead = true,
            canWrite = false,
            canCreate = false,
            canDelete = false,
        ...
        val FULL_LOCAL = StorageCapabilities(
            canRead = true,
            canWrite = true,
            canCreate = true,
            canDelete = true,
        ...
        val SAF_STORAGE = StorageCapabilities(
            canRead = true,
            canWrite = true,
            canCreate = true,
            canDelete = true,
        ...
        val MEDIA_STORE = StorageCapabilities(
            canRead = true,
            canWrite = false,
            canCreate = false,
            canDelete = true,
        ...
        val REMOTE_NETWORK = StorageCapabilities(
            canRead = true,
            canWrite = true,
            canCreate = true,
            canDelete = true,
        ...
        val APP_PRIVATE = StorageCapabilities(
            canRead = true,
            canWrite = true,
            canCreate = true,
            canDelete = true,
