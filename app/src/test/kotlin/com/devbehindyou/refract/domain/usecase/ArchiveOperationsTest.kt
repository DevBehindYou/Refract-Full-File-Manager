...
class ArchiveOperationsTest {
    ...
    private suspend fun writeBytesFile(
        parentId: FileNodeId,
        name: String,
        bytes: ByteArray,
    ): FileNodeId {
    ...
    @Test
    fun `compress and inspect archive works end-to-end`() =
        runTest {
    ...
    @Test
    fun `extract extracts archive files successfully`() =
        runTest {
    ...
    @Test
    fun `zip slip attack is detected and blocked`() =
        runTest {
    ...
    @Test
    fun `read text content handles truncation correctly`() =
        runTest {
    ...
    @Test
    fun `checksum calculation produces correct hashes`() =
        runTest {
